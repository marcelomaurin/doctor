...
AppId={{13BF7150-3F47-492E-A224-FBD73B51C1A1}
AppName={#MyAppName}
...
Source: "D:\projetos\maurinsoft\doctor\software\tools\GerReceitas\GerReceita.exe"; DestDir: "{app}"; Flags: ignoreversion
